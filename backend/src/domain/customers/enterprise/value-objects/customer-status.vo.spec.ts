...
describe('CustomerStatus', () => {
  it('should create a valid lead status', () => {
    ...
    if (result.isRight()) {
      ...
      expect(result.value.isLead()).toBe(true)
    }
  })
  ...
  it('should compare equality correctly', () => {
    const a = CustomerStatus.createUnsafe('lead')
    const b = CustomerStatus.createUnsafe('lead')
    const c = CustomerStatus.createUnsafe('active')
