...
import { PrismaTaskTemplateRepository } from './prisma/repositories/tasks/prisma-task-template.repository'
...
@Module({
  ...
  providers: [
    ...
    { provide: ITaskTemplateRepository, useClass: PrismaTaskTemplateRepository },
    // Activities
