...
// Traz ISocialAttributionLinkRepository: o webhook resolve o marcador de origem
// da primeira mensagem. Sem ciclo — SocialModule não conhece o WhatsApp.
import { SocialModule } from '@/infra/modules/social/social.module'
...
@Module({
  imports: [ConfigModule, MeetingsModule, GoToModule, SocialModule],
