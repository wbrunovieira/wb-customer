    ...
    <div className="flex flex-col gap-4">
          ...
          <table className="min-w-full divide-y divide-slate-200">
            <thead className="bg-slate-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium uppercase tracking-wide text-slate-500">Desde</th>
              </tr>
            </thead>
      ...
      {!showForm ? (
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
          <h3 className="mb-4 text-sm font-semibold text-slate-900">Novo usuário membro</h3>
          <form
            action={(fd) => {
              startTransition(() => {
                formAction(fd)
