...
export default async function NewMeetingPage({
  ...
  return (
    <div className="flex flex-col gap-6">
      <div>
        <h1 className="text-2xl font-bold tracking-tight text-white">Agendar Reunião</h1>
        <p className="mt-1 text-sm text-md">
          Cria o evento no Google Calendar e envia convite para os participantes.
        </p>
      </div>

      <div className="max-w-2xl rounded-xl border border-border-strong bg-surface p-6 shadow-sm">
        <ScheduleMeetingForm
